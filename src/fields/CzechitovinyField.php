...
namespace czechitas\czechitoviny\fields;

use czechitas\czechitoviny\Czechitoviny;
use czechitas\czechitoviny\assetbundles\czechitovinyfieldfield\CzechitovinyFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class CzechitovinyField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('czechitoviny', 'CzechitovinyField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'czechitoviny/_components/fields/CzechitovinyField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(CzechitovinyFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CzechitovinyCzechitovinyField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'czechitoviny/_components/fields/CzechitovinyField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
